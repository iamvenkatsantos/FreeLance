...
export class FrontComponent {
  ...
  doSum() {
    this.total =
      +this.user.hsc_language_marks +
      +this.user.hsc_english_marks +
      +this.user.hsc_maths_marks +
      +this.user.hsc_chemistry_marks +
      +this.user.hsc_physics_marks;
    this.user.hsc_total_marks = this.total;
  }
  doMaxsum() {
    this.total =
      +this.user.hsc_language_maxmark +
      +this.user.hsc_english_maxmark +
      +this.user.hsc_maths_maxmark +
      +this.user.hsc_chemistry_maxmark +
      +this.user.hsc_physics_maxmark;
  ...
  doCutoff() {
    this.total =
      +this.user.hsc_maths_marks * 0.5 +
      +this.user.hsc_chemistry_marks * 0.25 +
      +this.user.hsc_physics_marks * 0.25;
